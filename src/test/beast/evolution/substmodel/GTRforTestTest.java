...
import beast.evolution.substitutionmodel.GTRforTest;
...
public class GTRforTestTest extends TestCase {
    ...
    public void testGTR() throws Exception {
        for (Instance test : all) {
            ...
            System.setOut(new PrintStream(new FileOutputStream("/home/kuangyu/Desktop/GTR_checkExp.txt")));
