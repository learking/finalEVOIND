...
public class MCMCV extends Runnable {
...
//            }
            ...
            if (logHastingsRatio != Double.NEGATIVE_INFINITY) {
                ...
                System.out.println("logAlpha:" + logAlpha + " newL:" + newLogLikelihood + " oldL:" + oldLogLikelihood + " Hastings:" + logHastingsRatio);
                
                //lear:
                if(Math.abs(logAlpha) < 1E-3){
                    // reject
                    if (sampleNr >= 0) {
